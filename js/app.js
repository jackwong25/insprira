...
import { renderCreator, sendToCreator, doCheckWord, inspectSensitiveHtml, analyzeRewriteHotspots, openActionLogs, renderRewriteHotspots, selectRewriteHotspot, clearSelectedHotspot, doRewrite, copyRewrite, generateCover, clearCreatorSource, saveToDrafts } from './pages/creator.js';
...
registerAction('saveToDrafts', () => saveToDrafts());
